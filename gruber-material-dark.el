...
(defun gruber-material-dark--apply-faces (theme palette)
  ...
  (let* ((pg (lambda (k) (gruber-material-dark--lookup palette k)))
    ...
    (custom-theme-set-faces
     ...
     `(line-number ((t (:foreground ,bg4))))
     `(line-number-current-line ((t (:foreground ,yellow))))

     `(trailing-whitespace ((t (:foreground ,red :background ,bg-red))))

     `(whitespace-space ((t (:foreground ,bg1))))
     `(whitespace-hspace ((t (:foreground ,bg1))))
     `(whitespace-newline ((t (:foreground ,bg1))))
     `(whitespace-line ((t (:foreground ,bg1))))
     `(whitespace-trailing ((t (:foreground ,red))))
     `(whitespace-indentation ((t (:foreground ,bg1))))
     `(whitespace-tab ((t (:foreground ,quartz0))))
     `(whitespace-space-after-tab ((t (:foreground ,quartz0))))
     `(whitespace-space-before-tab ((t (:foreground ,quartz0))))
     `(whitespace-missing-newline-at-eof ((t (:foreground ,bg1))))
     ...
     `(treemacs-window-background-face ((t (:foreground ,quartz0 :background ,bg0-5))))
     `(treemacs-hl-line-face ((t (:background ,bg1 :extend t))))
     `(treemacs-root-face ((t (:foreground ,niagara2 :weight bold))))
     `(treemacs-directory-face ((t (:foreground ,fg0))))
     `(treemacs-file-face ((t (:foreground ,fg0))))
     `(treemacs-tags-face ((t (:foreground ,quartz0))))
     ...
     `(treemacs-git-renamed-face ((t (:foreground ,wisteria))))
     `(treemacs-git-conflict-face ((t (:foreground ,red))))
     `(treemacs-git-ignored-face ((t (:foreground ,quartz0))))
     ...
     `(dired-directory ((t (:foreground ,niagara2 :background ,bg0))))
     `(dired-flagged ((t (:foreground ,red :background ,bg0))))
     `(dired-header ((t (:foreground ,niagara2))))
     ...
     `(dirvish-file-time ((t (:foreground ,fg0))))
     `(dirvish-file-modes ((t (:foreground ,fg0))))
     `(dirvish-file-size ((t (:foreground ,fg0))))
     `(dirvish-hl-line ((t (:background ,bg1 :extend t))))
     `(dirvish-menu-heading ((t (:inherit dired-mark))))
     `(dirvish-hl-line-inactive ((t (:background ,bg0-5 :extend t))))
     `(dirvish-inactive ((t (:foreground ,quartz0))))
     `(dirvish-narrow-match-face-0 ((t (:foreground ,niagara2 :weight bold))))
     `(dirvish-narrow-match-face-1 ((t (:foreground ,wisteria :weight bold))))
     `(dirvish-narrow-match-face-2 ((t (:foreground ,green :weight bold))))
     `(dirvish-narrow-match-face-3 ((t (:foreground ,yellow :weight bold))))
     `(dirvish-vc-needs-merge-face ((t (:background ,bg-red))))
     ...
     `(magit-diff-whitespace-warning ((t (:foreground ,red :background ,bg-red))))
